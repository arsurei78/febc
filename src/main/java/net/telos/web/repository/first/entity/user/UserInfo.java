package net.telos.web.repository.first.entity.user;

import net.telos.cmmn.convert.GrantedAuthorityConverter;
import net.telos.web.repository.first.entity.base.BaseTime;
import lombok.*;
