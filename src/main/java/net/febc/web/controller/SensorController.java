...
import net.febc.web.repository.mongo.entity.FireSensorInfo;
import net.febc.web.service.impl.FireSensorServiceImpl;
import net.febc.web.dto.req.sensor.ReqFireSensorDto;
