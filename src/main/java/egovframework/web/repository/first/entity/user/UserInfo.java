package egovframework.web.repository.first.entity.user;

import egovframework.cmmn.convert.GrantedAuthorityConverter;
import egovframework.web.repository.first.entity.base.BaseTime;
import lombok.*;
...
public class UserInfo extends BaseTime {
    ...
    @Column(name = "admin_token", length = 40)
    @Comment("관리자 로그인 토큰(API 용) ")
